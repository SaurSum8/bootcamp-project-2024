var blogs = [
    ...
    },*/
    {
        title: "CalHacks 11.0",
        date: "23 Oct 2024",
        description: "Just returned from my first hackathon, CalHacks 11.0. It was an absolute blast!<br>" +
    ...
    },
    {
        ...
        date: "17 Oct 2024",
        description: "I am extremely excited to have been selected for the Hack4Impact Bootcamp!" +
...
function blogAdder() {
    var bset = document.getElementById("blog-set");
    blogs.forEach(function (blog) {
        var tdiv = document.createElement("div");
        var titleB = document.createElement("h1");
        var dateB = document.createElement("h5");
        ...
        bset === null || bset === void 0 ? void 0 : bset.appendChild(tdiv);
    });
}
blogAdder();
